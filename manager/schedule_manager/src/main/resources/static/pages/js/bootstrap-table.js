            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (that.options.columns[j].checkbox || that.options.columns[j].radio) {
                    ...
                    if(field=="addHandle"){
                 	   ...
                 	   value='<div id="toolbar" class="btn-group"><button type="button" class="btn btn-default addTask"><i class="glyphicon glyphicon-plus"></i></button></div>';
                    }
                    if(field == "url"){
                    	value="<a href='"+value+"' target='black'>"+value+"</a>";
                    }
                    if(field=="enabledTask"){
                     
                    	value='<div id="isStart" class="btn-group"><button  type="button" data-toggle="modal" class="btn btn-default isStart qidong" style="margin-right:10px;">启动</button><button  type="button" class="btn btn-default isStart jingyong">禁用</button></div>';
                    }
