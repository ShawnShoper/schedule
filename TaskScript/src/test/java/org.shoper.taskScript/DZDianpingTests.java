...
/**
 * Created by ShawnShoper on 16/9/7.
 */
public class DZDianpingTests {
...
public void Test1() throws MalformedURLException, InterruptedException {
	...
	public void Test () throws Exception {
		...
		jobParam.setJobCode("214");
		jobParam.setJobName("梅州");
		...
		taskTemplate.setCode(FileUtils
									 .readFileToString(new File(
											 "src/main/java/org/shoper/taskScript/script/DZDianping.java"))
									 .getBytes());
