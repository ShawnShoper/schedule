 ...
 */
public class BaiduXiaofangData extends JobCaller{
    private String charset = HttpClient.UTF_8;
    final int timeout = 20;
    final int retry = 3;
    private TimeUnit timeUnit = TimeUnit.SECONDS;
    private String cityName ="http://map.baidu.com/?newmap=1&&qt=con&from=webmap&c=%cityName%&wd=%E6%B6%88%E9%98%B2&&pn=";
    Thread getDatas;
    Thread saveDatas;
...
//                System.out.println("------------------------");
    ...
    {
        cityName=cityName.replace("%cityName%",args.getJobName());
        city=args.getJobName();
        province=args.getJobCode();
        return args;
    }
    /**
     * 任务处理方法,必须实现。
