 ...
 */
public class BaiDuMapHospitalData extends JobCaller{
    private String charset = HttpClient.UTF_8;
    final int timeout = 20;
    final int retry = 3;
    private TimeUnit timeUnit = TimeUnit.SECONDS;
//    private String cityName ="http://map.baidu.com/?newmap=1&reqflag=pcmap&biz=1&from=webmap&da_par=direct&qt=con&from=webmap&c=257&wd=wd=%E5%B9%BF%E4%B8%9C%E7%9C%81%20%E5%8C%BB%E9%99%A2&pn=";
    private String jdurl ="http://map.baidu.com/?newmap=1&reqflag=pcmap&biz=1&from=webmap&da_par=direct&qt=con&from=webmap&c=%cityName%&wd=wd=%E5%B9%BF%E4%B8%9C%E7%9C%81%20%E5%8C%BB%E9%99%A2&pn=";
    Thread getDatas;
    Thread saveDatas;
...
//                System.out.println("------------------------");
    ...
    {
        jdurl=jdurl.replace("%cityName%",args.getJobCode());
